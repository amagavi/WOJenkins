...
echo "		cp /${WORKSPACE}/Projects/${DEPLOYED_APPLICATION_NAME}/dist/${DEPLOYED_APPLICATION_NAME}-Application.tar.gz ${APP_ROOT}/releases/${DEPLOYED_APPLICATION_NAME}/${BUILD_ID}_${BUILD_NUMBER}/"
cp /${WORKSPACE}/Projects/${DEPLOYED_APPLICATION_NAME}/dist/${DEPLOYED_APPLICATION_NAME}-Application.tar.gz ${APP_ROOT}/releases/${DEPLOYED_APPLICATION_NAME}/${BUILD_ID}_${BUILD_NUMBER}/
echo "		cp /${WORKSPACE}/Projects/${DEPLOYED_APPLICATION_NAME}/dist/${DEPLOYED_APPLICATION_NAME}-WebServerResources.tar.gz ${WEB_ROOT}/releases/${DEPLOYED_APPLICATION_NAME}/${BUILD_ID}_${BUILD_NUMBER}/"
cp /${WORKSPACE}/Projects/${DEPLOYED_APPLICATION_NAME}/dist/${DEPLOYED_APPLICATION_NAME}-WebServerResources.tar.gz ${WEB_ROOT}/releases/${DEPLOYED_APPLICATION_NAME}/${BUILD_ID}_${BUILD_NUMBER}/
